...
import { PlanningTimetableHandler } from "./modules/handler/planningTimetable.handler";
...
import { PlanningTimetableRepository } from "./modules/repository/planningTimetable.repository";
...
import { PlanningTimetableService } from "./modules/service/planningTimetable.service";
...
export const fullPlanningHandler = new PlanningTimetableHandler(new PlanningTimetableService(new PlanningTimetableRepository()));
